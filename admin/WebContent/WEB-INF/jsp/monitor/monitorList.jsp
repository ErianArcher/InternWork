			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<c:choose>
					<c:when test="${not empty pageDataList}">
						<c:forEach items="${pageDataList}" var="pageData" varStatus="vs">
							<tr>
								<td class='center' style="width: 30px;">${vs.index+1}</td>
								<td>${pageData.className} ...</td>
								<td>${pageData.jsonString }</td>
								<td>${pageData.createTime }</td>
								<td>${pageData.updateTime }</td>
