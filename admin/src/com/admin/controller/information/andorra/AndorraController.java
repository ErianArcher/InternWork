package com.admin.controller.information.andorra;
...
import com.admin.util.upload.ImageAPI;
...
import com.admin.service.information.andorra.AndorraService;
...
public class AndorraController extends BaseController{
		...
		//图片上传
				...
				if (null != tp && !tp.isEmpty()) {
					try {
						...
						String imgUrl = ImageAPI.upload(tp.getInputStream(),id+extName,ImageAPI.getFileExt(extName));
	...
	public ModelAndView save(
		...
		//图片上传
				String pictureSaveFilePath = String.valueOf(Thread.currentThread().getContextClassLoader().getResource(""))+"../../";
				pictureSaveFilePath = pictureSaveFilePath.substring(6);		//去掉 'file:/'
				System.out.println("图片上传路径=============================="+pictureSaveFilePath );
				if (null != tp && !tp.isEmpty()) {
					try {
